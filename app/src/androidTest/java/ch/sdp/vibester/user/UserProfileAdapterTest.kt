...
class UserProfileAdapterTest {
    ...
    fun recyclerViewShowsCorrectCount() {
        ...
        val userProfileViewHolder: RecyclerView.Adapter<UserProfileAdapter.UserProfileViewHolder> = UserProfileAdapter(users, FireBaseAuthenticator(), DataGetter(), ImageGetter(), null)
